  ...
  return (
    <div className="flex h-screen bg-gray-900 text-white">
      ...
      <aside className="w-64 bg-gray-800 border-r border-gray-700 p-6 flex flex-col">
        <h2 className="text-2xl font-bold text-blue-500 mb-8">SmartTasks</h2>
        <nav className="flex-1 space-y-4">
          <Link to="/dashboard" className="block p-3 hover:bg-gray-700 rounded-lg">Dashboard</Link>
          <Link to="/analytics"className="block p-3 hover:bg-gray-700 rounded-lg">Analytics</Link>
          <Link to="/profile" className="block p-3 hover:bg-gray-700 rounded-lg">Profile</Link>
